        ...
        private void initFloating() {
                ...
                hideBtn.setOnClickListener(new View.OnClickListener() {
                            public void onClick(View view) {
                                    ...
                                    mExpanded.setVisibility(View.GONE);
                                    Toast.makeText(view.getContext(), "HIDE Mod Menu", Toast.LENGTH_LONG).show();
                                }
                        });
                hideBtn.setOnLongClickListener(new View.OnLongClickListener() {
                            public boolean onLongClick(View view) {
                                    Toast.makeText(view.getContext(), "KILL Mod Menu", Toast.LENGTH_LONG).show();
        ...
        private View TextField(final int featNum, final String featName, final boolean numOnly, final int maxValue) {
                ...
                button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                    ...
                                    TextViewNote.setText("Input Text: ");
                                    if (maxValue != 0)
